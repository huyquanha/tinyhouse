...
const listings: ListingDocument[] = [
  ...
  },
  {
    ...
    host: new ObjectId('5d378db94e84753160e08b59'),
    type: ListingType.APARTMENT,
  ...
  },
  {
    ...
    host: new ObjectId('5d378db94e84753160e08b58'),
    type: ListingType.HOUSE,
...
const seed = async () => {
  try {
    ...
    process.exit(); // without this program wont't terminate. Maybe becaues of active connection to mongoDB?
  } catch {
